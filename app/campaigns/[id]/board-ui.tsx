        ...
        <div className="mt-6 pt-4 border-t border-stone-100">
          {addingGroup ? (
            ...
            <button
              ...
              className="text-sm text-stone-500 hover:text-indigo-700"
            >
              + Add group
            </button>
          )}
  ...
  return (
    <form onSubmit={submit} className="flex items-center gap-2">
      <input
        ...
        required
        className="flex-1 px-3 py-1.5 border border-stone-300 rounded-lg text-sm focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100"
      />
      <input
        type="date"
        value={dueDate}
